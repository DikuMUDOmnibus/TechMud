...
void assign_mobiles(void)
{
	...
	mob_index[real_mobile(3064)].func = puff;
	mob_index[real_mobile(7012)].func = puff;

	mob_index[real_mobile(3060)].func = cityguard;
	mob_index[real_mobile(3067)].func = cityguard;
	mob_index[real_mobile(3068)].func = terminator;

	mob_index[real_mobile(1410)].func = cityguard;
	mob_index[real_mobile(1411)].func = cityguard;
	mob_index[real_mobile(1412)].func = cityguard;
