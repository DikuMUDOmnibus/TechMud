...
#define ITEM_BOAT      22
#define ITEM_TIME      23
#define ITEM_PHONE     24
#define ITEM_BEEPER     25
#define ITEM_PORTAL     26
#define ITEM_MODIFY     27
...
struct obj_data
{
	...
	struct char_data *equipted_by;  /* Carried by :NULL in room/conta   */
...
#define PLR_QUIET     32 /* block out shouters, tellers, comm devices*/
#define PLR_LOG         64 /* log activities of this player. */
#define PLR_FREEZE     128 /* No commands available */
#define PLR_GODINVIS   256 /* makes gods invisible to lower levelers */
#define PLR_PROMPT     512 /* makes you see prompt or not */
#define PLR_WIMPY     1024 /* whether you have wimpy set or not */
#define PLR_THIEF     2048 /* a thief */
#define PLR_KILLER    4096 /* a killer */
#define PLR_NEWBIE     8192  /* free gift at altar if pray */
#define PLR_AWARD     16384  /* free gift at altar if pray */
#define PLR_AGGRESSIVE    32768  /* aggressive attack */
#define PLR_HUNT    65536  /* You are hunting */
#define PLR_GRAPHICS    131072  /* You have agraphics */
...
struct char_special_data
{
	...
	unsigned long int act;               /* flags for NPC behavior                  */
	unsigned int wimpy;
...
struct char_file_u
{
  ...
  int played;    /* Number of secs played in total */
	...
	unsigned long int act;          /* ACT Flags                    */
	unsigned int wimpy;
